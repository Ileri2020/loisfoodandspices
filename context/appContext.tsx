...
export const AppContextProvider: React.FC<any> = ({ children }) => {
  ...
  const [user, setUser] = useState<UserProps>({ name: "visitor", id: "nil", email: "nil", image: "https://res.cloudinary.com/dc5khnuiu/image/upload/v1752627019/uxokaq0djttd7gsslwj9.png", role: "user", contact: "xxxx" });
